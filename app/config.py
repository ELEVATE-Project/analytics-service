...
class Settings(BaseSettings):
    ...
    DISCUSSION_CSV_COLUMN: str = Field(
        default='["id","Title","User name","User Location","District","Participant Count","Men","Women","Children","Date of Discussion","Organization","Challenges","Solutions","Author","Language","Report Created At","Transcript Link","Image Urls","PDF Urls","Session ID","PRI Member Name","PRI Member Designation","School Representative Name","School Representative Designation"]'
    )
    ...
    DISCUSSION_KAFKA_SCHEMA: str = Field(
        default='{"create": {"required": ["submissionId", "submissionType", "sessionId", "tenantCode", "eventType", "eventPublishedAt", "tags.state", "tags.district", "tags.organization", "tags.programId", "tags.programName", "tags.leaderCategoryId", "tags.leaderCategoryName", "data.title", "data.designation", "data.submissionDate", "data.discussionDate", "data.pdfUrls.original", "data.transcriptLink", "data.challenges", "data.solutions", "data.participantsData", "data.priMemberName", "data.priMemberDesignation", "data.schoolRepresentativeName", "data.schoolRepresentativeDesignation"], "optional": ["data.pdfUrls.masked", "data.author", "data.language", "data.imageUrls"]}, "update": {"required": ["submissionId", "submissionType", "sessionId", "tenantCode", "eventType", "eventPublishedAt"], "newValuesNoEmpty": true}, "delete": {"required": ["submissionId", "submissionType", "sessionId", "tenantCode", "eventType", "eventPublishedAt"]}}'
    )
